      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[95vh] flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-[#E0E0E0] flex justify-between items-center flex-shrink-0">
          <div>
            <h2 className="text-lg font-semibold text-[#333]">
              Table of Specifications Preview & Export
            </h2>
            <p className="text-sm text-[#666]">
              Shielded Metal Arc Welding (SMAW) NC II - Written Test
            </p>
          </div>
          <button
            aria-label="Close"
          ...
          <div className="flex items-start gap-2">
            <div className="flex-1">
              <div className="text-sm font-medium text-[#1976D2]">
                {totalItems} total items • {factualCount} Factual •{" "}
                {scenarioCount} Comprehension • {applicationCount} Application
              </div>
        ...
        <div className="flex-1 overflow-y-auto bg-[#F5F5F5] p-6">
          <div className="bg-white border border-[#E0E0E0] rounded-lg shadow-sm max-w-[900px] mx-auto p-8">
            ...
            <div className="text-center mb-6 pb-4 border-b-2 border-[#1976D2]">
              ...
              <div className="text-sm text-[#666]">
                ...
                <div className="text-xs">
                  Written Test • {totalItems} Items Total
                </div>
              </div>
            </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-[#1976D2]">
                    <th
                      className="px-4 py-3 text-center font-bold text-white border-2 border-[#1976D2]"
                      colSpan={6}
                    >
                      TABLE OF SPECIFICATION
                    </th>
                  ...
                  <tr className="bg-[#1976D2]">
                    <th
                      className="px-4 py-2 text-center font-semibold text-white text-sm border-2 border-[#1976D2]"
                      colSpan={6}
                    >
                      SHIELDED METAL ARC WELDING (SMAW) – National Certificate
                      II
                    </th>
                  </tr>
                  <tr className="bg-[#1976D2]">
                ...
                <tbody>
                  {tosData.map((row, idx) => (
                    <tr key={idx} className="hover:bg-[#FAFAFA]">
                      <td className="px-3 py-2 text-xs border border-[#999]">
                        {row.article}
                      </td>
                      <td className="px-3 py-2 text-xs text-center border border-[#999]">
                        {row.factual}
                      </td>
                      <td className="px-3 py-2 text-xs text-center border border-[#999]">
                        {row.comprehension}
                      ...
                      <td className="px-3 py-2 text-xs text-center border border-[#999] font-bold">
                        {row.total}
                      </td>
                      <td className="px-3 py-2 text-xs text-center border border-[#999]">
                        {row.percentage}
                  ...
                  <tr className="bg-[#E8F5E9]">
                    <td className="px-3 py-2 text-xs font-bold text-right border-2 border-[#2E7D32]">
                      TOTAL
                    </td>
            ...
            {/* Summary by Article */}
            <div className="mt-6">
              <h3 className="text-sm font-bold text-[#333] mb-3 uppercase">
                Summary by Article
              </h3>
              <table className="w-full border-collapse">
                <thead>
            ...
            <div className="mt-6 p-4 bg-[#E3F2FD] border-l-4 border-[#1976D2] rounded">
              <div className="text-xs font-semibold text-[#1976D2] mb-2">
                TOS Validation:
              </div>
              <ul className="text-xs text-[#1565C0] space-y-1">
                <li>
                  ✓ All {totalItems} MCQ items mapped to competency articles
                </li>
                <li>
                  ✓ Item distribution aligns with TESDA assessment guidelines
                </li>
                <li>
                  ✓ Balanced coverage across knowledge, comprehension, and
                  application levels
                </li>
        ...
        <div className="px-6 py-4 border-t border-[#E0E0E0] bg-[#FAFAFA] flex justify-between items-center flex-shrink-0">
          <div className="text-xs text-[#666]">
            Preview reflects current TOS • {totalItems} items
          </div>
