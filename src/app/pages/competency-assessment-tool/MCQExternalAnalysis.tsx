      ...
      <div className="bg-white border-2 border-[#1976D2] rounded mb-6">
        ...
        <div className="p-5">
          <div className="grid grid-cols-2 gap-4 mb-4">
            <button className="flex items-start gap-3 p-4 bg-white border border-[#E0E0E0] rounded hover:border-[#1976D2] hover:bg-[#F5FAFF] transition-all">
              <span className="text-3xl">
                <PencilSquareIcon className="w-8 h-8 inline text-zinc-500" />
              </span>
            ...
            <button className="flex items-start gap-3 p-4 bg-white border border-[#E0E0E0] rounded hover:border-[#1976D2] hover:bg-[#F5FAFF] transition-all">
              <span className="text-3xl">
                <ClipboardDocumentListIcon className="w-8 h-8 inline text-zinc-500" />
              </span>
              <div className="flex-1 text-left">
                <div className="font-semibold text-sm text-[#333] mb-1">
            ...
            <button className="flex items-start gap-3 p-4 bg-white border border-[#E0E0E0] rounded hover:border-[#1976D2] hover:bg-[#F5FAFF] transition-all">
              <span className="text-3xl">
                <KeyIcon className="w-8 h-8 inline text-zinc-500" />
              </span>
              <div className="flex-1 text-left">
                <div className="font-semibold text-sm text-[#333] mb-1">
                  Answer Key + Item Analysis Sheet
                </div>
                <div className="text-xs text-[#666]">
            ...
            <button className="flex items-start gap-3 p-4 bg-white border border-[#E0E0E0] rounded hover:border-[#1976D2] hover:bg-[#F5FAFF] transition-all">
              <span className="text-3xl">
                <ChartBarIcon className="w-8 h-8 inline text-zinc-500" />
              </span>
              <div className="flex-1 text-left">
                <div className="font-semibold text-sm text-[#333] mb-1">
                ...
                <div className="text-xs text-[#666]">
                  Automated difficulty & discrimination calculator
                </div>
              </div>
            </button>
          </div>
          ...
          <button className="w-full px-6 py-3 bg-[#1976D2] text-white rounded text-sm font-bold hover:bg-[#1565C0] transition-colors">
            <FolderArrowDownIcon className="w-5 h-5 inline mr-2" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-[#999] bg-[#FAFAFA] p-2 rounded border border-[#E0E0E0]">
                  ...
                  varying skill levels (high, medium, low) for better
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-[#666] mb-2">
                  Conduct the pilot test under controlled conditions. Allow
                  45-60 minutes. Ensure no coaching or collaboration.
                </div>
                <div className="text-xs text-[#999] bg-[#FAFAFA] p-2 rounded border border-[#E0E0E0]">
                  <strong>Tip:</strong> Record test duration and any questions
                  participants found confusing for later revision.
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-[#666] mb-2">
                  Use the Answer Key to score all answer sheets. Calculate total
                  score for each participant.
                </div>
                <div className="text-xs text-[#999] bg-[#FAFAFA] p-2 rounded border border-[#E0E0E0]">
                  <strong>Formula:</strong> Total Score = Number of Correct
                  Answers ÷ 50 × 100
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <ul className="text-sm text-[#666] ml-5 space-y-1 list-disc mb-2">
                  <li>
                    <strong>Difficulty Index (P):</strong> % of participants who
                    answered correctly (Target: 0.30 - 0.80)
                  </li>
                  <li>
                    <strong>Discrimination Index (D):</strong> Difference
                    between high and low scorers (Target: ≥0.30)
                  </li>
                  <li>
                    <strong>Distractor Analysis:</strong> Check if all options
                    are plausible
                  </li>
                </ul>
                <div className="text-xs text-[#999] bg-[#FFFDE7] p-2 rounded border border-[#FFE082]">
                  <strong>Red Flags:</strong> Items with P {"<"} 0.20 (too
                  difficult), P {">"} 0.90 (too easy), or D {"<"} 0.20 (poor
                  discrimination) should be revised or removed.
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-[#666] mb-2">
                  Based on analysis results, revise problematic items. Replace
                  items with poor psychometric properties. Re-test if
                  significant changes are made.
                </div>
                <div className="text-xs text-[#999] bg-[#E8F5E9] p-2 rounded border border-[#A5D6A7]">
                  <strong>Final Pool:</strong> Aim for 50 quality items with
                  good difficulty and discrimination indices before distribution
                  into 5 packages.
                </div>
              </div>
            </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="border-b border-[#F0F0F0]">
                ...
                <td className="px-4 py-3 text-sm text-[#2E7D32]">
                  0.30 - 0.80
                </td>
                <td className="px-4 py-3 text-xs text-[#666]">
