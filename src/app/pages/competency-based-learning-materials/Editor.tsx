...
export function CBLMEditor() {
  ...
  return (
    <div className="-m-6 flex h-[calc(100vh-5rem)] flex-col overflow-hidden bg-white text-gray-800">
      ...
      <div
        className={`flex items-center gap-2 rounded border px-4 py-2 text-xs font-medium ${
          noticeValidated
      ...
      <div className="flex min-h-0 flex-1 border border-gray-200 bg-gray-50">
