          ...
          <table className="w-full">
            ...
            <tbody>
              {tosData.map((row, idx) => (
                ...
                >
                  <td className="px-4 py-3 text-sm font-medium text-[#333]">
                    {row.unitTitle}
                  </td>
              ...
              <tr className="bg-[#F1F8F4]">
                <td className="px-4 py-3 text-sm font-semibold text-[#666]">
                  Percentage (%)
                </td>
                <td className="text-center px-4 py-3 text-sm text-[#666]">
                ...
                <td className="text-center px-4 py-3 text-sm font-bold text-[#2E7D32]">
                  100%
                </td>
              </tr>
            </tbody>
      ...
      <div className="bg-white border border-[#E0E0E0] rounded mb-6">
        ...
        <div className="p-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-[#E8F5E9] border border-[#A5D6A7] rounded">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-xl">
                  <CheckIcon className="w-8 h-8 inline text-green-500" />
                </span>
            ...
            <div className="p-4 bg-[#E8F5E9] border border-[#A5D6A7] rounded">
              ...
              <div className="text-xs text-[#1B5E20]">
                All 3 unit competencies covered • All cognitive levels
                represented
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 p-3 bg-[#FFFDE7] border border-[#FFE082] rounded text-xs text-[#F57C00]">
            <strong>Note:</strong> This is the master pool TOS. During Phase 3
            distribution, each of the 5 packages will receive a subset of items
            and generate its own per-package TOS automatically.
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="h-4 bg-[#E0E0E0] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(totals.learning / totals.total) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-4 bg-[#E0E0E0] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(totals.application / totals.total) * 100}%`,
                  }}
                />
              </div>
            </div>
