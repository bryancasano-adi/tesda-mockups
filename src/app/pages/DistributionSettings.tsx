  ...
  return (
    <div className="p-6">
      <div className="text-sm text-[#666] mb-4">
        Training Projects › Shielded Metal Arc Welding NC II › CATS Development › Distribution Settings
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#666]">Configure how Phase 2 pools are distributed into 5 CATS packages</p>
      </div>
      ...
      <div className="bg-[#E8F5E9] border border-[#A5D6A7] rounded p-5 mb-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-xs text-[#1B5E20]">
          ...
          <div>
            ...
            <div>→ 5 Assessor's Guides (Sets A-E)</div>
      ...
      <div className="bg-white border border-[#E0E0E0] rounded mb-6">
        <div className="px-5 py-4 border-b border-[#E0E0E0]">
          <div className="font-semibold text-[15px] text-[#333]">MCQ Distribution Settings</div>
        </div>
        <div className="p-5">
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  max={50}
                />
                <span className="text-sm text-[#666]">items per set (from pool of 50)</span>
              </div>
              <div className="text-xs text-[#999] mt-2">
                Each of the 5 packages will contain {mcqItemsPerSet} MCQ items drawn from the master pool.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="px-4 py-2 bg-[#FAFAFA] rounded border border-[#E0E0E0]">
                <div className="text-2xl font-bold text-[#1976D2]">{mcqItemsPerSet * 5}</div>
                <div className="text-xs text-[#666]">items across 5 packages (some items may repeat)</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border border-[#E0E0E0] rounded mb-6">
        <div className="px-5 py-4 border-b border-[#E0E0E0]">
          <div className="font-semibold text-[15px] text-[#333]">Questioning Tool Distribution Settings</div>
        </div>
        <div className="p-5">
          ...
          <div className="p-4 bg-[#E3F2FD] border border-[#90CAF9] rounded">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm text-[#1565C0]">
                <strong>Distribution Strategy:</strong> Questions from the 25-question pool will be
                distributed across 5 packages ensuring each PC is covered and 4-Dimensions requirements are
                met in each package.
              </div>
            </div>
          </div>
      ...
      <div className="bg-white border border-[#E0E0E0] rounded mb-6">
        <div className="px-5 py-4 border-b border-[#E0E0E0]">
          <div className="font-semibold text-[15px] text-[#333]">Safety Questions Requirements</div>
        </div>
        <div className="p-5">
          <label className="flex items-center gap-3 cursor-pointer">
            <div className="relative inline-block w-12 h-6">
              ...
              />
              <div className="w-12 h-6 bg-[#E0E0E0] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#2E7D32]"></div>
            </div>
            <div>
              ...
              <div className="text-xs text-[#666]">
                When enabled, each of the 5 packages will include at least one safety-focused question.
              </div>
            </div>
          </label>
          ...
          {includeSafetyQs && (
            <div className="mt-4 p-3 bg-[#FFFDE7] border border-[#FFE082] rounded text-xs text-[#F57C00]">
              ⚠️ <strong>Validation:</strong> The system will verify that enough safety questions exist in
              the pool before distribution.
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white border border-[#E0E0E0] rounded mb-6">
        <div className="px-5 py-4 border-b border-[#E0E0E0]">
          <div className="font-semibold text-[15px] text-[#333]">Demonstration Test Mapping</div>
        </div>
        <div className="p-5">
          <div className="text-sm text-[#666] mb-4">
            The 5 demonstration test variations (Sets A-E) from Phase 2 will be mapped 1:1 to the 5 CATS
            packages:
          </div>
              ...
              <tbody>
                {(['A', 'B', 'C', 'D', 'E'] as const).map((set) => (
                  <tr key={set} className="hover:bg-[#FAFAFA]">
                    ...
                    <td className="px-4 py-3 text-sm border-b border-[#F0F0F0]">Set {set}</td>
      ...
      <div className="bg-white border border-[#E0E0E0] rounded mb-6">
        <div className="px-5 py-4 border-b border-[#E0E0E0]">
          <div className="font-semibold text-[15px] text-[#333]">Distribution Summary</div>
        </div>
        <div className="p-5">
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div className="p-4 bg-[#FAFAFA] rounded border border-[#E0E0E0]">
              <div className="text-xs text-[#666] mb-1">Documents per Package</div>
              <div className="text-2xl font-bold text-[#1976D2]">6</div>
              <div className="text-xs text-[#666]">AG, SIC, Written, Rating, SAG, CARS</div>
            </div>
            <div className="p-4 bg-[#FAFAFA] rounded border border-[#E0E0E0]">
              <div className="text-xs text-[#666] mb-1">Total Deliverables</div>
              <div className="text-2xl font-bold text-[#1976D2]">30</div>
              <div className="text-xs text-[#666]">5 packages × 6 documents</div>
            </div>
          </div>
          ...
          <div className="p-4 bg-[#E3F2FD] border border-[#90CAF9] rounded text-sm">
            ...
            <ul className="text-xs text-[#1565C0] space-y-1 ml-5 list-disc">
              <li>
                <strong>Per-Package (unique):</strong> Assessor's Guide, SIC, Written Test + TOS, Rating Sheet
              </li>
              <li>
                <strong>Shared (identical):</strong> SAG, CARS (same across all 5 packages)
              </li>
            </ul>
          </div>
        </div>
